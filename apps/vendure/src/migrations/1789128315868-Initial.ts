...
export class Initial1789128315868 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<any> {
    await queryRunner.query(
      "CREATE TABLE `collection_asset` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `assetId` int NOT NULL, `position` int NOT NULL, `collectionId` int NOT NULL, `id` int NOT NULL AUTO_INCREMENT, INDEX `IDX_51da53b26522dc0525762d2de8` (`assetId`), INDEX `IDX_1ed9e48dfbf74b5fcbb35d3d68` (`collectionId`), PRIMARY KEY (`id`)) ENGINE=InnoDB",
      undefined,
    );
    await queryRunner.query(
      "CREATE TABLE `collection_translation` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `languageCode` varchar(255) NOT NULL, `name` varchar(255) NOT NULL, `slug` varchar(255) NOT NULL, `description` text NOT NULL, `id` int NOT NULL AUTO_INCREMENT, `baseId` int NULL, INDEX `IDX_9f9da7d94b0278ea0f7831e1fc` (`slug`), INDEX `IDX_e329f9036210d75caa1d8f2154` (`baseId`), PRIMARY KEY (`id`)) ENGINE=InnoDB",
      undefined,
    );
    await queryRunner.query(
      "CREATE TABLE `collection` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `isRoot` tinyint NOT NULL DEFAULT 0, `position` int NOT NULL, `isPrivate` tinyint NOT NULL DEFAULT 0, `filters` text NOT NULL, `inheritFilters` tinyint NOT NULL DEFAULT 1, `id` int NOT NULL AUTO_INCREMENT, `parentId` int NULL, `featuredAssetId` int NULL, INDEX `IDX_7256fef1bb42f1b38156b7449f` (`featuredAssetId`), PRIMARY KEY (`id`)) ENGINE=InnoDB",
      undefined,
    );
    await queryRunner.query(
      "CREATE TABLE `facet_translation` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `languageCode` varchar(255) NOT NULL, `name` varchar(255) NOT NULL, `id` int NOT NULL AUTO_INCREMENT, `baseId` int NULL, INDEX `IDX_eaea53f44bf9e97790d38a3d68` (`baseId`), PRIMARY KEY (`id`)) ENGINE=InnoDB",
      undefined,
    );
    await queryRunner.query(
      "CREATE TABLE `facet` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `isPrivate` tinyint NOT NULL DEFAULT 0, `code` varchar(255) NOT NULL, `id` int NOT NULL AUTO_INCREMENT, UNIQUE INDEX `IDX_0c9a5d053fdf4ebb5f0490b40f` (`code`), PRIMARY KEY (`id`)) ENGINE=InnoDB",
      undefined,
    );
    await queryRunner.query(
      "CREATE TABLE `facet_value_translation` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `languageCode` varchar(255) NOT NULL, `name` varchar(255) NOT NULL, `id` int NOT NULL AUTO_INCREMENT, `baseId` int NULL, INDEX `IDX_3d6e45823b65de808a66cb1423` (`baseId`), PRIMARY KEY (`id`)) ENGINE=InnoDB",
      undefined,
    );
    await queryRunner.query(
      "CREATE TABLE `facet_value` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `code` varchar(255) NOT NULL, `id` int NOT NULL AUTO_INCREMENT, `facetId` int NOT NULL, INDEX `IDX_d101dc2265a7341be3d94968c5` (`facetId`), PRIMARY KEY (`id`)) ENGINE=InnoDB",
      undefined,
    );
    await queryRunner.query(
      "CREATE TABLE `product_option_translation` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `languageCode` varchar(255) NOT NULL, `name` varchar(255) NOT NULL, `id` int NOT NULL AUTO_INCREMENT, `baseId` int NULL, INDEX `IDX_a79a443c1f7841f3851767faa6` (`baseId`), PRIMARY KEY (`id`)) ENGINE=InnoDB",
      undefined,
    );
    await queryRunner.query(
      "CREATE TABLE `product_option` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `deletedAt` datetime NULL, `code` varchar(255) NOT NULL, `id` int NOT NULL AUTO_INCREMENT, `groupId` int NOT NULL, INDEX `IDX_a6debf9198e2fbfa006aa10d71` (`groupId`), PRIMARY KEY (`id`)) ENGINE=InnoDB",
      undefined,
    );
    await queryRunner.query(
      "CREATE TABLE `product_option_group_translation` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `languageCode` varchar(255) NOT NULL, `name` varchar(255) NOT NULL, `id` int NOT NULL AUTO_INCREMENT, `baseId` int NULL, INDEX `IDX_93751abc1451972c02e033b766` (`baseId`), PRIMARY KEY (`id`)) ENGINE=InnoDB",
      undefined,
    );
    await queryRunner.query(
      "CREATE TABLE `product_option_group` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `deletedAt` datetime NULL, `code` varchar(255) NOT NULL, `id` int NOT NULL AUTO_INCREMENT, PRIMARY KEY (`id`)) ENGINE=InnoDB",
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      "CREATE TABLE `product_translation` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `languageCode` varchar(255) NOT NULL, `name` varchar(255) NOT NULL, `slug` varchar(255) NOT NULL, `description` text NOT NULL, `id` int NOT NULL AUTO_INCREMENT, `baseId` int NULL, INDEX `IDX_f4a2ec16ba86d277b6faa0b67b` (`slug`), INDEX `IDX_7dbc75cb4e8b002620c4dbfdac` (`baseId`), PRIMARY KEY (`id`)) ENGINE=InnoDB",
      undefined,
    );
    await queryRunner.query(
      "CREATE TABLE `product` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `deletedAt` datetime NULL, `enabled` tinyint NOT NULL DEFAULT 1, `id` int NOT NULL AUTO_INCREMENT, `featuredAssetId` int NULL, INDEX `IDX_91a19e6613534949a4ce6e76ff` (`featuredAssetId`), PRIMARY KEY (`id`)) ENGINE=InnoDB",
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      "CREATE TABLE `asset_translation` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `languageCode` varchar(255) NOT NULL, `name` varchar(255) NOT NULL, `id` int NOT NULL AUTO_INCREMENT, `baseId` int NULL, INDEX `IDX_4eed4464adef51f53e1c7d8021` (`baseId`), PRIMARY KEY (`id`)) ENGINE=InnoDB",
      undefined,
    );
    await queryRunner.query(
      "CREATE TABLE `asset` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `type` varchar(255) NOT NULL, `mimeType` varchar(255) NOT NULL, `width` int NOT NULL DEFAULT '0', `height` int NOT NULL DEFAULT '0', `fileSize` int NOT NULL, `source` varchar(255) NOT NULL, `preview` varchar(255) NOT NULL, `focalPoint` text NULL, `id` int NOT NULL AUTO_INCREMENT, PRIMARY KEY (`id`)) ENGINE=InnoDB",
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      "CREATE TABLE `fulfillment` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `state` varchar(255) NOT NULL, `trackingCode` varchar(255) NOT NULL DEFAULT '', `method` varchar(255) NOT NULL, `handlerCode` varchar(255) NOT NULL, `id` int NOT NULL AUTO_INCREMENT, PRIMARY KEY (`id`)) ENGINE=InnoDB",
      undefined,
    );
    await queryRunner.query(
      "CREATE TABLE `refund` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `method` varchar(255) NOT NULL, `reason` varchar(255) NULL, `state` varchar(255) NOT NULL, `transactionId` varchar(255) NULL, `metadata` text NOT NULL, `id` int NOT NULL AUTO_INCREMENT, `paymentId` int NOT NULL, `items` int NOT NULL, `shipping` int NOT NULL, `adjustment` int NOT NULL, `total` int NOT NULL, INDEX `IDX_1c6932a756108788a361e7d440` (`paymentId`), PRIMARY KEY (`id`)) ENGINE=InnoDB",
      undefined,
    );
    await queryRunner.query(
      "CREATE TABLE `payment` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `method` varchar(255) NOT NULL, `state` varchar(255) NOT NULL, `errorMessage` varchar(255) NULL, `transactionId` varchar(255) NULL, `metadata` text NOT NULL, `id` int NOT NULL AUTO_INCREMENT, `amount` int NOT NULL, `orderId` int NULL, INDEX `IDX_d09d285fe1645cd2f0db811e29` (`orderId`), PRIMARY KEY (`id`)) ENGINE=InnoDB",
      undefined,
    );
    await queryRunner.query(
      "CREATE TABLE `surcharge` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `description` varchar(255) NOT NULL, `listPriceIncludesTax` tinyint NOT NULL, `sku` varchar(255) NOT NULL, `taxLines` text NOT NULL, `id` int NOT NULL AUTO_INCREMENT, `listPrice` int NOT NULL, `orderId` int NULL, `orderModificationId` int NULL, INDEX `IDX_154eb685f9b629033bd266df7f` (`orderId`), INDEX `IDX_a49c5271c39cc8174a0535c808` (`orderModificationId`), PRIMARY KEY (`id`)) ENGINE=InnoDB",
      undefined,
    );
    await queryRunner.query(
      "CREATE TABLE `order_modification` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `note` varchar(255) NOT NULL, `shippingAddressChange` text NULL, `billingAddressChange` text NULL, `id` int NOT NULL AUTO_INCREMENT, `priceChange` int NOT NULL, `orderId` int NULL, `paymentId` int NULL, `refundId` int NULL, INDEX `IDX_1df5bc14a47ef24d2e681f4559` (`orderId`), PRIMARY KEY (`id`)) ENGINE=InnoDB",
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      "CREATE TABLE `promotion` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `deletedAt` datetime NULL, `startsAt` datetime NULL, `endsAt` datetime NULL, `couponCode` varchar(255) NULL, `perCustomerUsageLimit` int NULL, `usageLimit` int NULL, `enabled` tinyint NOT NULL, `conditions` text NOT NULL, `actions` text NOT NULL, `priorityScore` int NOT NULL, `id` int NOT NULL AUTO_INCREMENT, PRIMARY KEY (`id`)) ENGINE=InnoDB",
      undefined,
    );
    await queryRunner.query(
      "CREATE TABLE `shipping_method_translation` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `languageCode` varchar(255) NOT NULL, `name` varchar(255) NOT NULL DEFAULT '', `description` varchar(255) NOT NULL DEFAULT '', `id` int NOT NULL AUTO_INCREMENT, `baseId` int NULL, INDEX `IDX_85ec26c71067ebc84adcd98d1a` (`baseId`), PRIMARY KEY (`id`)) ENGINE=InnoDB",
      undefined,
    );
    await queryRunner.query(
      "CREATE TABLE `shipping_method` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `deletedAt` datetime NULL, `code` varchar(255) NOT NULL, `checker` text NOT NULL, `calculator` text NOT NULL, `fulfillmentHandlerCode` varchar(255) NOT NULL, `id` int NOT NULL AUTO_INCREMENT, PRIMARY KEY (`id`)) ENGINE=InnoDB",
      undefined,
    );
    await queryRunner.query(
      "CREATE TABLE `shipping_line` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `listPriceIncludesTax` tinyint NOT NULL, `adjustments` text NOT NULL, `taxLines` text NOT NULL, `id` int NOT NULL AUTO_INCREMENT, `shippingMethodId` int NOT NULL, `listPrice` int NOT NULL, `orderId` int NULL, INDEX `IDX_e2e7642e1e88167c1dfc827fdf` (`shippingMethodId`), INDEX `IDX_c9f34a440d490d1b66f6829b86` (`orderId`), PRIMARY KEY (`id`)) ENGINE=InnoDB",
      undefined,
    );
    await queryRunner.query(
      "CREATE TABLE `order` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `type` varchar(255) NOT NULL DEFAULT 'Regular', `code` varchar(255) NOT NULL, `state` varchar(255) NOT NULL, `active` tinyint NOT NULL DEFAULT 1, `orderPlacedAt` datetime NULL, `couponCodes` text NOT NULL, `shippingAddress` text NOT NULL, `billingAddress` text NOT NULL, `currencyCode` varchar(255) NOT NULL, `id` int NOT NULL AUTO_INCREMENT, `aggregateOrderId` int NULL, `customerId` int NULL, `taxZoneId` int NULL, `subTotal` int NOT NULL, `subTotalWithTax` int NOT NULL, `shipping` int NOT NULL DEFAULT '0', `shippingWithTax` int NOT NULL DEFAULT '0', INDEX `IDX_73a78d7df09541ac5eba620d18` (`aggregateOrderId`), UNIQUE INDEX `IDX_729b3eea7ce540930dbb706949` (`code`), INDEX `IDX_af13739f4962eab899bdff34be` (`orderPlacedAt`), INDEX `IDX_124456e637cca7a415897dce65` (`customerId`), PRIMARY KEY (`id`)) ENGINE=InnoDB",
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      "CREATE TABLE `stock_movement` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `type` varchar(255) NOT NULL, `quantity` int NOT NULL, `id` int NOT NULL AUTO_INCREMENT, `stockLocationId` int NOT NULL, `discriminator` varchar(255) NOT NULL, `productVariantId` int NULL, `orderLineId` int NULL, INDEX `IDX_e65ba3882557cab4febb54809b` (`productVariantId`), INDEX `IDX_a2fe7172eeae9f1cca86f8f573` (`stockLocationId`), INDEX `IDX_d2c8d5fca981cc820131f81aa8` (`orderLineId`), PRIMARY KEY (`id`)) ENGINE=InnoDB",
      undefined,
    );
    await queryRunner.query(
      "CREATE TABLE `order_line` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `quantity` int NOT NULL, `orderPlacedQuantity` int NOT NULL DEFAULT '0', `listPriceIncludesTax` tinyint NOT NULL, `adjustments` text NOT NULL, `taxLines` text NOT NULL, `id` int NOT NULL AUTO_INCREMENT, `sellerChannelId` int NULL, `shippingLineId` int NULL, `productVariantId` int NOT NULL, `taxCategoryId` int NULL, `initialListPrice` int NULL, `listPrice` int NOT NULL, `featuredAssetId` int NULL, `orderId` int NULL, INDEX `IDX_6901d8715f5ebadd764466f7bd` (`sellerChannelId`), INDEX `IDX_dc9ac68b47da7b62249886affb` (`shippingLineId`), INDEX `IDX_cbcd22193eda94668e84d33f18` (`productVariantId`), INDEX `IDX_77be94ce9ec650446617946227` (`taxCategoryId`), INDEX `IDX_9f065453910ea77d4be8e92618` (`featuredAssetId`), INDEX `IDX_239cfca2a55b98b90b6bef2e44` (`orderId`), PRIMARY KEY (`id`)) ENGINE=InnoDB",
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      "CREATE TABLE `product_variant_asset` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `assetId` int NOT NULL, `position` int NOT NULL, `productVariantId` int NOT NULL, `id` int NOT NULL AUTO_INCREMENT, INDEX `IDX_10b5a2e3dee0e30b1e26c32f5c` (`assetId`), INDEX `IDX_fa21412afac15a2304f3eb35fe` (`productVariantId`), PRIMARY KEY (`id`)) ENGINE=InnoDB",
      undefined,
    );
    await queryRunner.query(
      "CREATE TABLE `product_variant_price` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `currencyCode` varchar(255) NOT NULL, `id` int NOT NULL AUTO_INCREMENT, `channelId` int NULL, `price` int NOT NULL, `variantId` int NULL, INDEX `IDX_e6126cd268aea6e9b31d89af9a` (`variantId`), PRIMARY KEY (`id`)) ENGINE=InnoDB",
      undefined,
    );
    await queryRunner.query(
      "CREATE TABLE `product_variant_translation` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `languageCode` varchar(255) NOT NULL, `name` varchar(255) NOT NULL, `id` int NOT NULL AUTO_INCREMENT, `baseId` int NULL, INDEX `IDX_420f4d6fb75d38b9dca79bc43b` (`baseId`), PRIMARY KEY (`id`)) ENGINE=InnoDB",
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      "CREATE TABLE `tax_category` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `name` varchar(255) NOT NULL, `isDefault` tinyint NOT NULL DEFAULT 0, `id` int NOT NULL AUTO_INCREMENT, PRIMARY KEY (`id`)) ENGINE=InnoDB",
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      "CREATE TABLE `zone` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `name` varchar(255) NOT NULL, `id` int NOT NULL AUTO_INCREMENT, PRIMARY KEY (`id`)) ENGINE=InnoDB",
      undefined,
    );
    await queryRunner.query(
      "CREATE TABLE `tax_rate` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `name` varchar(255) NOT NULL, `enabled` tinyint NOT NULL, `value` decimal(5,2) NOT NULL, `id` int NOT NULL AUTO_INCREMENT, `categoryId` int NULL, `zoneId` int NULL, `customerGroupId` int NULL, INDEX `IDX_7ee3306d7638aa85ca90d67219` (`categoryId`), INDEX `IDX_9872fc7de2f4e532fd3230d191` (`zoneId`), INDEX `IDX_8b5ab52fc8887c1a769b9276ca` (`customerGroupId`), PRIMARY KEY (`id`)) ENGINE=InnoDB",
      undefined,
    );
    await queryRunner.query(
      "CREATE TABLE `customer_group` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `name` varchar(255) NOT NULL, `id` int NOT NULL AUTO_INCREMENT, PRIMARY KEY (`id`)) ENGINE=InnoDB",
      undefined,
    );
    await queryRunner.query(
      "CREATE TABLE `authentication_method` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `identifier` varchar(255) NULL, `passwordHash` varchar(255) NULL, `verificationToken` varchar(255) NULL, `passwordResetToken` varchar(255) NULL, `identifierChangeToken` varchar(255) NULL, `pendingIdentifier` varchar(255) NULL, `strategy` varchar(255) NULL, `externalIdentifier` varchar(255) NULL, `metadata` text NULL, `id` int NOT NULL AUTO_INCREMENT, `type` varchar(255) NOT NULL, `userId` int NULL, INDEX `IDX_00cbe87bc0d4e36758d61bd31d` (`userId`), INDEX `IDX_a23445b2c942d8dfcae15b8de2` (`type`), PRIMARY KEY (`id`)) ENGINE=InnoDB",
      undefined,
    );
    await queryRunner.query(
      "CREATE TABLE `role` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `code` varchar(255) NOT NULL, `description` varchar(255) NOT NULL, `permissions` text NOT NULL, `id` int NOT NULL AUTO_INCREMENT, PRIMARY KEY (`id`)) ENGINE=InnoDB",
      undefined,
    );
    await queryRunner.query(
      "CREATE TABLE `session` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `token` varchar(255) NOT NULL, `expires` datetime NOT NULL, `invalidated` tinyint NOT NULL, `authenticationStrategy` varchar(255) NULL, `id` int NOT NULL AUTO_INCREMENT, `activeOrderId` int NULL, `activeChannelId` int NULL, `type` varchar(255) NOT NULL, `userId` int NULL, UNIQUE INDEX `IDX_232f8e85d7633bd6ddfad42169` (`token`), INDEX `IDX_7a75399a4f4ffa48ee02e98c05` (`activeOrderId`), INDEX `IDX_eb87ef1e234444728138302263` (`activeChannelId`), INDEX `IDX_3d2f174ef04fb312fdebd0ddc5` (`userId`), PRIMARY KEY (`id`)) ENGINE=InnoDB",
      undefined,
    );
    await queryRunner.query(
      "CREATE TABLE `user` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `deletedAt` datetime NULL, `identifier` varchar(255) NOT NULL, `verified` tinyint NOT NULL DEFAULT 0, `lastLogin` datetime NULL, `id` int NOT NULL AUTO_INCREMENT, PRIMARY KEY (`id`)) ENGINE=InnoDB",
      undefined,
    );
    await queryRunner.query(
      "CREATE TABLE `customer` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `deletedAt` datetime NULL, `title` varchar(255) NULL, `firstName` varchar(255) NOT NULL, `lastName` varchar(255) NOT NULL, `phoneNumber` varchar(255) NULL, `emailAddress` varchar(255) NOT NULL, `id` int NOT NULL AUTO_INCREMENT, `userId` int NULL, UNIQUE INDEX `REL_3f62b42ed23958b120c235f74d` (`userId`), PRIMARY KEY (`id`)) ENGINE=InnoDB",
      undefined,
    );
    await queryRunner.query(
      "CREATE TABLE `address` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `fullName` varchar(255) NOT NULL DEFAULT '', `company` varchar(255) NOT NULL DEFAULT '', `streetLine1` varchar(255) NOT NULL, `streetLine2` varchar(255) NOT NULL DEFAULT '', `city` varchar(255) NOT NULL DEFAULT '', `province` varchar(255) NOT NULL DEFAULT '', `postalCode` varchar(255) NOT NULL DEFAULT '', `phoneNumber` varchar(255) NOT NULL DEFAULT '', `defaultShippingAddress` tinyint NOT NULL DEFAULT 0, `defaultBillingAddress` tinyint NOT NULL DEFAULT 0, `id` int NOT NULL AUTO_INCREMENT, `customerId` int NULL, `countryId` int NULL, INDEX `IDX_dc34d382b493ade1f70e834c4d` (`customerId`), INDEX `IDX_d87215343c3a3a67e6a0b7f3ea` (`countryId`), PRIMARY KEY (`id`)) ENGINE=InnoDB",
      undefined,
    );
    await queryRunner.query(
      "CREATE TABLE `administrator` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `deletedAt` datetime NULL, `firstName` varchar(255) NOT NULL, `lastName` varchar(255) NOT NULL, `emailAddress` varchar(255) NOT NULL, `id` int NOT NULL AUTO_INCREMENT, `userId` int NULL, UNIQUE INDEX `REL_1966e18ce6a39a82b19204704d` (`userId`), PRIMARY KEY (`id`)) ENGINE=InnoDB",
      undefined,
    );
    await queryRunner.query(
      "CREATE TABLE `global_settings` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `availableLanguages` text NOT NULL, `trackInventory` tinyint NOT NULL DEFAULT 1, `outOfStockThreshold` int NOT NULL DEFAULT '0', `id` int NOT NULL AUTO_INCREMENT, PRIMARY KEY (`id`)) ENGINE=InnoDB",
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      "CREATE TABLE `api_key_translation` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `languageCode` varchar(255) NOT NULL, `name` varchar(255) NOT NULL, `id` int NOT NULL AUTO_INCREMENT, `baseId` int NULL, INDEX `IDX_bf45bd67c7b3278d7e1f2f9517` (`baseId`), PRIMARY KEY (`id`)) ENGINE=InnoDB",
      undefined,
    );
    await queryRunner.query(
      "CREATE TABLE `api_key` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `lookupId` varchar(255) NOT NULL, `apiKeyHash` varchar(255) NOT NULL, `lastUsedAt` datetime NULL, `deletedAt` datetime NULL, `id` int NOT NULL AUTO_INCREMENT, `ownerId` int NOT NULL, `userId` int NOT NULL, UNIQUE INDEX `IDX_ade30668b991772489bf875be5` (`lookupId`), UNIQUE INDEX `IDX_3c254ac4ce1a6d4a26da30c557` (`apiKeyHash`), PRIMARY KEY (`id`)) ENGINE=InnoDB",
      undefined,
    );
    await queryRunner.query(
      "CREATE TABLE `channel` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `code` varchar(255) NOT NULL, `token` varchar(255) NOT NULL, `description` varchar(255) NULL DEFAULT '', `defaultLanguageCode` varchar(255) NOT NULL, `availableLanguageCodes` text NULL, `defaultCurrencyCode` varchar(255) NOT NULL, `availableCurrencyCodes` text NULL, `trackInventory` tinyint NOT NULL DEFAULT 1, `outOfStockThreshold` int NOT NULL DEFAULT '0', `pricesIncludeTax` tinyint NOT NULL, `id` int NOT NULL AUTO_INCREMENT, `sellerId` int NULL, `defaultTaxZoneId` int NULL, `defaultShippingZoneId` int NULL, INDEX `IDX_af2116c7e176b6b88dceceeb74` (`sellerId`), INDEX `IDX_afe9f917a1c82b9e9e69f7c612` (`defaultTaxZoneId`), INDEX `IDX_c9ca2f58d4517460435cbd8b4c` (`defaultShippingZoneId`), UNIQUE INDEX `IDX_06127ac6c6d913f4320759971d` (`code`), UNIQUE INDEX `IDX_842699fce4f3470a7d06d89de8` (`token`), PRIMARY KEY (`id`)) ENGINE=InnoDB",
      undefined,
    );
    await queryRunner.query(
      "CREATE TABLE `history_entry` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `type` varchar(255) NOT NULL, `isPublic` tinyint NOT NULL, `data` text NOT NULL, `id` int NOT NULL AUTO_INCREMENT, `discriminator` varchar(255) NOT NULL, `administratorId` int NULL, `customerId` int NULL, `orderId` int NULL, INDEX `IDX_92f8c334ef06275f9586fd0183` (`administratorId`), INDEX `IDX_43ac602f839847fdb91101f30e` (`customerId`), INDEX `IDX_3a05127e67435b4d2332ded7c9` (`orderId`), PRIMARY KEY (`id`)) ENGINE=InnoDB",
      undefined,
    );
    await queryRunner.query(
      "CREATE TABLE `job_record` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `queueName` varchar(255) NOT NULL, `data` text NULL, `state` varchar(255) NOT NULL, `progress` int NOT NULL, `result` text NULL, `error` varchar(255) NULL, `startedAt` datetime(6) NULL, `settledAt` datetime(6) NULL, `isSettled` tinyint NOT NULL, `retries` int NOT NULL, `attempts` int NOT NULL, `id` int NOT NULL AUTO_INCREMENT, INDEX `IDX_86bc376c56af8cefd41a847a95` (`createdAt`), PRIMARY KEY (`id`)) ENGINE=InnoDB",
      undefined,
    );
    await queryRunner.query(
      "CREATE TABLE `job_record_buffer` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `bufferId` varchar(255) NOT NULL, `job` text NOT NULL, `id` int NOT NULL AUTO_INCREMENT, PRIMARY KEY (`id`)) ENGINE=InnoDB",
      undefined,
    );
    await queryRunner.query(
      "CREATE TABLE `scheduled_task_record` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `taskId` varchar(255) NOT NULL, `enabled` tinyint NOT NULL DEFAULT 1, `lockedAt` datetime(3) NULL, `lastExecutedAt` datetime(3) NULL, `manuallyTriggeredAt` datetime(3) NULL, `lastResult` json NULL, `id` int NOT NULL AUTO_INCREMENT, UNIQUE INDEX `IDX_661876d97056cad9fd37eaa877` (`taskId`), PRIMARY KEY (`id`)) ENGINE=InnoDB",
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      "CREATE TABLE `api_key_channels_channel` (`apiKeyId` int NOT NULL, `channelId` int NOT NULL, INDEX `IDX_460b1afc096014ca2dc5a5f5aa` (`apiKeyId`), INDEX `IDX_d37be6b22047f56ea87bea795b` (`channelId`), PRIMARY KEY (`apiKeyId`, `channelId`)) ENGINE=InnoDB",
      undefined,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(
      "ALTER TABLE `api_key_channels_channel` DROP FOREIGN KEY `FK_d37be6b22047f56ea87bea795b6`",
      undefined,
    );
    await queryRunner.query(
      "ALTER TABLE `api_key_channels_channel` DROP FOREIGN KEY `FK_460b1afc096014ca2dc5a5f5aa9`",
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      "ALTER TABLE `api_key` DROP FOREIGN KEY `FK_74d2236b1de818d00bd3fd01602`",
      undefined,
    );
    await queryRunner.query(
      "ALTER TABLE `api_key_translation` DROP FOREIGN KEY `FK_bf45bd67c7b3278d7e1f2f95170`",
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      "ALTER TABLE `asset_translation` DROP FOREIGN KEY `FK_4eed4464adef51f53e1c7d80212`",
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      "DROP INDEX `IDX_d37be6b22047f56ea87bea795b` ON `api_key_channels_channel`",
      undefined,
    );
    await queryRunner.query(
      "DROP INDEX `IDX_460b1afc096014ca2dc5a5f5aa` ON `api_key_channels_channel`",
      undefined,
    );
    ...
    await queryRunner.query(
      "DROP INDEX `IDX_9a5a6a556f75c4ac7bfdd03410` ON `search_index_item`",
      undefined,
    );
    await queryRunner.query(
      "DROP INDEX `IDX_d8791f444a8bf23fe4c1bc020c` ON `search_index_item`",
      undefined,
    );
    await queryRunner.query(
      "DROP INDEX `IDX_6fb55742e13e8082954d0436dc` ON `search_index_item`",
      undefined,
    );
    await queryRunner.query("DROP TABLE `search_index_item`", undefined);
    await queryRunner.query(
      "DROP INDEX `IDX_661876d97056cad9fd37eaa877` ON `scheduled_task_record`",
      undefined,
    );
    ...
    await queryRunner.query(
      "DROP INDEX `IDX_842699fce4f3470a7d06d89de8` ON `channel`",
      undefined,
    );
    await queryRunner.query(
      "DROP INDEX `IDX_06127ac6c6d913f4320759971d` ON `channel`",
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      "DROP INDEX `IDX_3c254ac4ce1a6d4a26da30c557` ON `api_key`",
      undefined,
    );
    await queryRunner.query(
      "DROP INDEX `IDX_ade30668b991772489bf875be5` ON `api_key`",
      undefined,
    );
    await queryRunner.query("DROP TABLE `api_key`", undefined);
    await queryRunner.query(
      "DROP INDEX `IDX_bf45bd67c7b3278d7e1f2f9517` ON `api_key_translation`",
      undefined,
    );
    ...
    await queryRunner.query(
      "DROP INDEX `REL_1966e18ce6a39a82b19204704d` ON `administrator`",
      undefined,
    );
    ...
    await queryRunner.query(
      "DROP INDEX `REL_3f62b42ed23958b120c235f74d` ON `customer`",
      undefined,
    );
    ...
    await queryRunner.query(
      "DROP INDEX `IDX_232f8e85d7633bd6ddfad42169` ON `session`",
      undefined,
    );
    ...
    await queryRunner.query(
      "DROP INDEX `IDX_729b3eea7ce540930dbb706949` ON `order`",
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      "DROP INDEX `IDX_4eed4464adef51f53e1c7d8021` ON `asset_translation`",
      undefined,
    );
    ...
    await queryRunner.query(
      "DROP INDEX `IDX_0c9a5d053fdf4ebb5f0490b40f` ON `facet`",
      undefined,
    );
